...
input_filedir=sys.argv[2] #02_fq_statistic
output_filedir=sys.argv[3] #03_fq_stat_json
cdr3_filedir=sys.argv[4] #01_fq_output
...
for filehead in file_list:
    ...
    for cellbarcode_name in cellbarcode_ls:
        ...
        if cellbarcode_name in contig_info_df["cell_barcode"].values:
            ...
            dict_tmp={
                ...
                'assembled_reads_number':int(tpm_2_df['assembled_reads_number'].values[0]),                
            ...
            cdr3_file_path="./"+cdr3_filedir+"/"+filehead+"/"+filehead+"_"+cellbarcode_name+"_cdr3.out"
    ...
    f=open("./"+output_filedir+"/"+filehead+"trust4_fq_results.json",'w')
